...
const colorDark = Color(0x1affffff);
const colorGreen = Color(0xff7BB655);
const colorRed = Color(0xffc62828);

TextTheme defaultText = TextTheme(
    headline1: GoogleFonts.irishGrover(fontWeight: FontWeight.bold, fontSize: 96),
    ...
    headline6: GoogleFonts.nunito(fontWeight: FontWeight.bold, fontSize: 20, color: Colors.white),
